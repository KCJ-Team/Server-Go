...
const (
	...
	ResponseCode_CONFLICT    ResponseCode = 4
)
...
type Response struct {
	...
	Code    ResponseCode `protobuf:"varint,1,opt,name=code,proto3,enum=messages.ResponseCode" json:"code,omitempty"` // 응답 코드
	Message string       `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`                       // 응답 메세지
...
func (x *Response) GetRoomInfo() *RoomInfo {
	if x, ok := x.GetData().(*Response_RoomInfo); ok {
		return x.RoomInfo
	}
	return nil
}
...
type Response_RoomInfo struct {
	RoomInfo *RoomInfo `protobuf:"bytes,3,opt,name=roomInfo,proto3,oneof"`
}

func (*Response_RoomInfo) isResponse_Data() {}
...
var file_response_proto_rawDesc = []byte{
	...
	0x12, 0x08, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x1a, 0x0e, 0x72, 0x6f, 0x6f, 0x6d,
	0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8a, 0x01, 0x0a, 0x08, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2a, 0x0a, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x16, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73,
	...
	0x08, 0x72, 0x6f, 0x6f, 0x6d, 0x49, 0x6e, 0x66, 0x6f, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x12, 0x2e, 0x72, 0x6f, 0x6f, 0x6d, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x52, 0x6f, 0x6f, 0x6d, 0x49,
	0x6e, 0x66, 0x6f, 0x48, 0x00, 0x52, 0x08, 0x72, 0x6f, 0x6f, 0x6d, 0x49, 0x6e, 0x66, 0x6f, 0x42,
	0x06, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x2a, 0x54, 0x0a, 0x0c, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x0c, 0x0a, 0x08, 0x43, 0x4f, 0x4e, 0x46, 0x4c, 0x49, 0x43, 0x54, 0x10, 0x04, 0x42, 0x12, 0x5a,
	0x10, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2d, 0x67, 0x6f, 0x2f, 0x73, 0x72, 0x63, 0x2f, 0x70,
...
var file_response_proto_goTypes = []any{
	(ResponseCode)(0), // 0: messages.ResponseCode
	(*Response)(nil),  // 1: messages.Response
	(*RoomInfo)(nil),  // 2: roomInfo.RoomInfo
}
var file_response_proto_depIdxs = []int32{
	0, // 0: messages.Response.code:type_name -> messages.ResponseCode
	2, // 1: messages.Response.roomInfo:type_name -> roomInfo.RoomInfo
